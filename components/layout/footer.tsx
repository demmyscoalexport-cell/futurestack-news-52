...
const socialLinks = [
  { name: 'Twitter', href: 'https://twitter.com/futurestacknews', icon: Twitter },
  { name: 'LinkedIn', href: 'https://linkedin.com/company/futurestacknews', icon: Linkedin },
  { name: 'YouTube', href: 'https://youtube.com/@futurestacknews', icon: Youtube },
      ...
      <div className="container mx-auto px-4 py-12 lg:px-8">
          ...
          <div className="flex flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
            <div className="max-w-xl">
              ...
              <p className="mt-2 text-muted-foreground">
                Get the top 5 AI tools + 1 hidden gem every Tuesday. Join 12,000+ subscribers.
              </p>
            </div>
        ...
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-5">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              Your AI-Powered Edge in SaaS & Automation. Discover, compare, and build tool stacks.
            </p>
            {/* Social Links */}
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 lg:flex-row">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} FutureStack News. All rights reserved.
          </p>
          <p className="text-sm text-muted-foreground">
