      ...
      >
        <div className="p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <Badge
              variant="outline"
              className={cn("text-xs", roleColors[stack.targetRole])}
            >
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-muted-foreground">
              {stack.tools?.length || 0} tools · {stack.cloneCount} clones
            </p>
          </div>
        ...
        <div className="flex items-center gap-2">
          {displayTools.map((tool) => (
            <ToolLogo
              ...
              tool={tool}
              size={10}
              className="transition-transform group-hover:scale-105 ring-2 ring-background"
            />
          ))}
          {remainingCount > 0 && (
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-muted text-sm font-medium text-muted-foreground">
