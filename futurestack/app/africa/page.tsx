...
const AFRICA_FILTERS = [
  { icon: Wifi, label: "Works on 3G", count: "80+ tools", color: "text-blue-400", bg: "bg-blue-500/10", border: "border-blue-500/20" },
  { icon: Smartphone, label: "Android Optimized", count: "95+ tools", color: "text-emerald-400", bg: "bg-emerald-500/10", border: "border-emerald-500/20" },
  { icon: DollarSign, label: "Naira Friendly", count: "70+ tools", color: "text-green-400", bg: "bg-green-500/10", border: "border-green-500/20" },
  { icon: Zap, label: "Free Plan Available", count: "120+ tools", color: "text-amber-400", bg: "bg-amber-500/10", border: "border-amber-500/20" },
  { icon: Globe, label: "No VPN Required", count: "110+ tools", color: "text-violet-400", bg: "bg-violet-500/10", border: "border-violet-500/20" },
  { icon: Star, label: "Paystack Compatible", count: "45+ tools", color: "text-pink-400", bg: "bg-pink-500/10", border: "border-pink-500/20" },
];

const COUNTRIES = [
  { flag: "🇳🇬", name: "Nigeria", city: "Lagos", users: "4.2K", trend: "↑ 32%" },
  { flag: "🇰🇪", name: "Kenya", city: "Nairobi", users: "2.8K", trend: "↑ 28%" },
  { flag: "🇬🇭", name: "Ghana", city: "Accra", users: "1.9K", trend: "↑ 41%" },
  { flag: "🇿🇦", name: "South Africa", city: "Cape Town", users: "3.1K", trend: "↑ 19%" },
  { flag: "🇪🇬", name: "Egypt", city: "Cairo", users: "1.4K", trend: "↑ 24%" },
  { flag: "🇹🇿", name: "Tanzania", city: "Dar es Salaam", users: "890", trend: "↑ 35%" },
  { flag: "🇷🇼", name: "Rwanda", city: "Kigali", users: "720", trend: "↑ 52%" },
  { flag: "🇺🇬", name: "Uganda", city: "Kampala", users: "650", trend: "↑ 38%" },
];
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
              {AFRICA_FILTERS.map((f) => {
                ...
                return (
                  <button
                    key={f.label}
                    className={`rounded-xl border ${f.border} ${f.bg} p-4 text-center hover:opacity-90 transition-all group`}
                  >
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-2">
              {COUNTRIES.map((c) => (
                <button
                  key={c.name}
                  className="rounded-xl border border-border/50 bg-card p-3 text-center hover:border-primary/40 transition-all"
                >
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {AFRICA_STACKS.map((stack) => (
                <div key={stack.title} className="rounded-xl border border-border/50 bg-card p-4 hover:border-primary/40 transition-all">
