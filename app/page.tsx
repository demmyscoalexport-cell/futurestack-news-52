...
import { tools, articles, stacks, toolCategories } from '@/lib/data'
...
const roleHeadlines: Record<UserRole, { headline: string; subheadline: string; cta: string }> = {
  'freelancer': {
    headline: 'AI Tools That Help Freelancers Win More Clients',
    subheadline: 'Discover tools that boost your productivity and help you deliver better work, faster.',
    cta: 'Explore Freelancer Tools',
  },
  'agency': {
    headline: 'Scale Your Agency with AI-Powered Workflows',
    subheadline: 'Build efficient operations and deliver exceptional results for your clients.',
    cta: 'Explore Agency Tools',
  },
  'saas-founder': {
    headline: 'Ship Faster with the Right AI Stack',
    subheadline: 'Tools and strategies to build, launch, and grow your SaaS product.',
...
export default function HomePage() {
  ...
  const currentHeadline = selectedRole 
    ...
    : {
        ...
        subheadline: 'Discover, compare, and combine the best AI tools for freelancers, agencies, and SaaS founders.',
        cta: 'Explore Tools',
      }

  const featuredArticles = articles.filter(a => a.featured).slice(0, 4)
  const topTools = tools.slice(0, 5)
  const featuredStacks = stacks.filter(s => s.featured).slice(0, 3)

  const handleAddToStack = (tool: Tool) => {
    // In a real app, this would add to a cart/stack state
    console.log('Adding tool to stack:', tool.name)
  }
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-bold text-foreground lg:text-3xl">Latest News</h2>
                <p className="mt-2 text-muted-foreground">Stay ahead with AI tools and SaaS insights</p>
              </div>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-foreground lg:text-3xl">Top-Rated AI Tools This Week</h2>
                  <p className="mt-1 text-muted-foreground">Based on user reviews and engagement</p>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-foreground lg:text-3xl">Popular Stacks</h2>
                  <p className="mt-1 text-muted-foreground">Pre-built tool combinations to get started fast</p>
                </div>
              </div>
              <Button variant="ghost" asChild>
                <Link href="/stacks">
        ...
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-muted-foreground">Find the perfect AI tools for your workflow</p>
            </div>
              ...
              {toolCategories.map((category) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="mt-1 text-xs text-muted-foreground">{category.count} tools</span>
                  </Link>
                )
              })}
            </div>
        ...
        {/* Final CTA */}
        <section className="border-t border-border bg-gradient-to-b from-background to-primary/5 py-16 lg:py-24">
          <div className="container mx-auto px-4 text-center lg:px-8">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground text-balance">
              Join thousands of freelancers, agencies, and founders who use FutureStack News to discover and organize their tools.
            </p>
